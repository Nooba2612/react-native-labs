  ...
  return (
    <View style={{height: "100%"}}>
      <View style={{flexDirection: "row", backgroundColor: "white"}}>
        <Image style={{width:130, height:160}} source={require("../assets/vs_red.png")} />
        <View style={{justifyContent: "space-evenly"}}>
           <Text>Điện Thoại Vsmart Joy 3 Hàng chính hãng</Text>
          <Text>Màu: <Text style={{fontWeight: "bold"}}>đỏ</Text></Text>
      ...
      <Pressable onPress={() => navigation.navigate("Screen4")} style={{flexDirection: "row", justifyContent:"space-around",alignItems: "center", width: "100%", borderRadius: 7, padding: 5, backgroundColor:"#1952E294", position: "absolute", bottom: 10}}><Text style={{color: "white", fontWeight: "bold"}}>XONG</Text></Pressable>
    </View>
  )
